...
客户端上传流程和服务端上传类似，差别在于：移动端直传文件所需的 `upload_token` 可以选择在客户方的业务服务器端生成，也可以选择在客户方的客户端程序里边生成。选择前者，可以和客户方的业务揉合得更紧密和安全些，比如防伪造请求。
...
如果还没有您自己的域名，可将 YOUR_DOMAIN 改成 `<bucketName>.qiniudn.com` 供临时测试使用。
